...
module ResearchMetrics =
    let private metricIds =
        [ "OBS-CHAIN-COMPLETE"
          "OBS-SOURCE-RESOLUTION-RATE"
          "OBS-EXPORT-BYTE-IDENTICAL"
          "OBS-NON-INTERFERENCE"
          "OBS-UNKNOWN-RATE"
          "TIME-WALL-MS"
          "TIME-TO-OUTCOME-MS"
          "TIME-TO-FIRST-GREEN-MS"
          "TIME-TO-HUMAN-MS"
          "AGENT-UNINTERRUPTED-MAX-MS"
          "TOOL-ACTIVE-MS"
          "WAIT-MS"
          "MODE-AUTONOMOUS-MS"
          "MODE-HUMAN-DIRECTED-MS"
          "ACTIVITY-AGENT-ACTIVE-MS"
          "ACTIVITY-IDLE-MS"
          "ACTIVITY-SLEEPING-MS"
          "ACTIVITY-BLOCKED-MS"
          "ACTIVITY-OFFLINE-MS"
          "ACTIVITY-AGENT-ACTIVE-RATIO"
          "INT-COUNT"
          "INT-I0-OBSERVATION"
          "INT-I1-CLARIFICATION"
          "INT-I2-SCOPE-CRITERIA-CHANGE"
          "INT-I3-TECHNICAL-DIRECTION"
          "INT-I4-DOMAIN-DECISION"
          "INT-I5-PRIORITY-CHANGE"
          "INT-I6-DEFECT-REPORT"
          "INT-I7-TECHNICAL-UNBLOCK"
          "INT-I8-INFRASTRUCTURE"
          "INT-I9-REVIEW-PROMOTION"
          "INT-I10-EMERGENCY-STOP"
          "INT-I11-OTHER"
          "INT-UNKNOWN"
          "INT-RATE-PER-HOUR"
          "INT-QUESTION-UNANSWERED"
          "INT-OPEN"
          "INT-CLOSED-ACTIVE-MS"
          "GATE-ATTEMPTS-TOTAL"
          "GATE-FAILED-ATTEMPTS"
          "GATE-BLOCKED-ATTEMPTS"
          "GATE-FIRST-PASS-ATTEMPTS"
          "GATE-COVERAGE"
          "GATE-PASS-COVERAGE"
          "REPAIR-CYCLES"
          "REVIEW-FINDINGS"
          ...
          "CHANGE-BINARY-FILES"
          "ARCH-PRODUCTION-FILES"
          "ARCH-MODULES-TOUCHED"
          "ARCH-CROSS-MODULE"
          "ARCH-REF-EDGES-ADDED"
          "ARCH-REF-EDGES-REMOVED"
          "ARCH-BOUNDARY-VIOLATIONS"
          "ARCH-PRODUCTION-LINES"
          "ARCH-TEST-LINES"
          "ARCH-ANALYZER-WARNINGS"
          "ARCH-TEST-COUNT"
          "ARCH-TEST-GROWTH"
          "ARCH-INTEGRATION-CONCENTRATION"
          "ARCH-ACCEPTED-CHECKPOINT-COVERAGE"
          "TRACE-AC-EVIDENCE-COVERAGE"
          "TRACE-EVENT-SOURCE-COVERAGE"
          "QUALITY-OUTCOME"
          "QUALITY-DETERMINISTIC-REPEAT"
          "QUALITY-POST-ACCEPT-DEFECTS"
          "USE-REQUESTS"
          "USE-INPUT-TOKENS"
          "USE-OUTPUT-TOKENS"
          "USE-CACHE-READ-TOKENS"
          "USE-CACHE-WRITE-TOKENS"
          "USE-COST-AMOUNT"
          "USE-COST-ESTIMATED-AMOUNT"
          "USE-MACHINE-CPU-MS"
          "USE-ENERGY-WH"
          "PERF-CPU-P50-MS"
          "PERF-CPU-P95-MS"
          ...
          "PERF-FRAME-P95-MS"
          "PERF-FRAME-P99-MS"
          "PERF-ONE-PCT-LOW-FPS"
          "PERF-HITCH-COUNT"
          "PERF-RAM-RESIDENT-MAX-BYTES"
          "PERF-RAM-PEAK-BYTES"
          "PERF-VRAM-DIRECT-BYTES"
          "PERF-VRAM-ESTIMATE-BYTES"
          "PERF-LOAD-COLD-MS"
          "PERF-LOAD-WARM-MS"
          "PERF-DRAW-CALLS"
          "PERF-TRIANGLES"
          ...
          "TASK-REJECTED"
          "TASK-ACCEPTED"
          "TASK-PLAN-TO-READY-MS"
          "TASK-READY-TO-IMPLEMENTED-MS"
          "TASK-IMPLEMENTED-TO-REVIEWED-MS"
          "TASK-READY-TO-ACCEPTED-MS"
          "TASK-READY-TO-ACCEPT-RATE"
          "TASK-REJECTION-RATE"
          "WIP-SNAPSHOTS"
          "WIP-DISTINCT-TREES"
          "WIP-PROMOTED-7D-RATE"
          "FAIL-BUILD"
          "FAIL-TEST"
          "FAIL-LINT"
          "FAIL-SECURITY"
          ...
          "REPAIR-FIXED"
          "REPAIR-SUCCESS-RATE"
          "REPAIR-ATTEMPTS-PER-FIX"
          "REPAIR-TIME-TO-FIX-MS"
          "FAIL-RECURRENCE-RATE"
          "CONTEXT-COMPACTIONS"
          "RUN-RESUMES"
          "RESUME-CONTINUITY-RATE"
          "ROUTING-DECISIONS"
          "MODEL-SWITCHES"
          "MODEL-SWITCHES-PER-RUN"
          "MODEL-DWELL-MS"
          "ROUTING-OUTCOME-RATE"
          "BLOCK-BUDGET"
          "BLOCK-RATE"
          "BLOCK-PROVIDER"
          ...
          "GIT-SUPERSESSIONS"
          "PROMOTION-RATE"
          "ROLLBACK-PER-PROMOTION"
          "IMPLEMENTED-TO-PROMOTED-MS"
          "HUMAN-INSTRUCTION"
          "HUMAN-REVIEW"
          "HUMAN-CORRECTION"
          "HUMAN-APPROVAL"
          ...
          "HUMAN-OBSERVATION"
          "HUMAN-COUNTED-RATE"
          "HUMAN-CORRECTIONS-PER-ACCEPTED"
          "HUMAN-EMERGENCY-RATE"
          "OUTCOME-MILESTONES"
          "OUTCOME-TAGS"
          "WINDOW-DAYS"
          "ACCEPTED-OUTCOMES-PER-DAY"
          "MILESTONES-PER-DAY"
          "FILES-PER-ACCEPTED"
          "LINES-PER-ACCEPTED"
          ...
          "REWORK-RATIO"
          "ROLLBACK-RATE"
          "ACCEPTED-STREAK-NO-HUMAN"
          "WIP-SNAPSHOT-PER-ACCEPTED"
          "WIP-TREE-ACCEPT-RATE"
          "DISCARDED-TREES-7D"
          "DISCARDED-LINES-7D"
          "GATE-RECOVERY-MS"
          "PROD-TEST-CHANGE-RATIO"
          "USE-TOKENS-TOTAL"
          "USE-TOKENS-PER-ACCEPTED"
          "USE-COST-PER-ACCEPTED"
          "USE-COST-PER-FIX"
          "HUMAN-ACTIVE-MINUTES"
          "HUMAN-MINUTES-PER-ACCEPTED"
          "PRODUCTIVE-AUTONOMY-MS"
          "PRODUCTIVE-AUTONOMY-MS-PER-ACCEPTED"
          "ACCEPTED-PER-1M-TOKENS"
          "ACCEPTED-PER-AUTO-ACTIVE-HOUR" ]

    let private unitOf (metricId: string) =
        if metricId.EndsWith("-MS", StringComparison.Ordinal) then
            "ms"
        elif metricId.EndsWith("-MINUTES", StringComparison.Ordinal) then
            "minutes"
        elif
            metricId.EndsWith("-RATE", StringComparison.Ordinal)
            || metricId.EndsWith("-RATIO", StringComparison.Ordinal)
            || metricId.EndsWith("-COVERAGE", StringComparison.Ordinal)
        then
            "ratio"
        elif metricId.Contains("TOKENS", StringComparison.Ordinal) then
            "tokens"
        elif metricId.Contains("LINES", StringComparison.Ordinal) then
            "lines"
        elif metricId.Contains("COST", StringComparison.Ordinal) then
            "ISO-currency"
        elif metricId = "WINDOW-DAYS" then
            "days"
        elif
            metricId.StartsWith("OBS-", StringComparison.Ordinal)
            || metricId.StartsWith("QUALITY-", StringComparison.Ordinal)
            || metricId = "ARCH-CROSS-MODULE"
            || metricId = "PERF-BUDGET-RESULT"
        then
            "boolean-or-enum"
        else
            "count"
    ...
    let private invariantRatio (numerator: int64) (denominator: int64) =
        if denominator = 0L then
            ...
            Some(
                (Decimal.Round(decimal numerator / decimal denominator, 6, MidpointRounding.AwayFromZero))
    ...
    let private evidenceClassOf (events: ResearchEvent list) =
        match
            events
            |> List.map (fun event -> event.Body.EvidenceClass)
            |> Set.ofList
            |> Set.toList
        with
        | [ value ] -> value
    ...
    let private monotonicDuration (startType: string) (endType: string) (events: ResearchEvent list) =
        ...
        | [ started ], [ finished ] ->
            ...
            | ResearchValue.Known startNs,
              ...
              ResearchValue.Known endClock when startClock = endClock && endNs >= startNs ->
    ...
    let private durationMs (started: ResearchEvent) (finished: ResearchEvent) =
        ...
        | ResearchValue.Known startNs,
          ResearchValue.Known startClock,
          ResearchValue.Known endNs,
          ResearchValue.Known endClock when
            started.Body.ObservationId = finished.Body.ObservationId
            && startClock = endClock
            && endNs >= startNs
            ->
            Some((endNs - startNs) / 1_000_000L)
    ...
    let private median (values: int64 list) =
        ...
        | ordered ->
            ...
            if ordered.Length % 2 = 1 then
                Some ordered[middle]
            else
                Some((ordered[middle - 1] + ordered[middle]) / 2L)
    ...
    let private unionDuration (intervals: (int64 * int64) list) =
        let rec collect currentStart currentEnd remaining total =
            ...
            | (startNs, endNs) :: tail -> collect startNs endNs tail (total + currentEnd - currentStart)
    ...
    let private pairedTaskMedian startType endType (events: ResearchEvent list) =
        let taskEvents (eventType: string) (sourceEvents: ResearchEvent list) =
            ...
            |> List.choose (fun event ->
                ResearchValue.toOption event.Body.TaskId |> Option.map (fun task -> task, event))
            |> List.groupBy fst
    ...
    let private fullyBoundedToolDuration (events: ResearchEvent list) =
        let tools =
            events |> List.filter (fun event -> event.Body.EventType = "tool.finished")
        ...
        if List.isEmpty tools then
            ...
            let intervals =
                ...
                |> List.map (fun event ->
                    match
                        payloadInt64 "startedMonotonicNs" event,
                        payloadInt64 "completedMonotonicNs" event,
                        ResearchValue.toOption event.Body.MonotonicClockId
                    with
                    | Some startNs, Some endNs, Some clock when endNs >= startNs -> Some(clock, startNs, endNs)
                    | _ -> None)

            if intervals |> List.exists Option.isNone then
                None
            else
                let known = intervals |> List.choose id

                if (known |> List.map (fun (clock, _, _) -> clock) |> Set.ofList).Count <> 1 then
                    None
                else
                    Some(
                        unionDuration (known |> List.map (fun (_, startNs, endNs) -> startNs, endNs))
                        / 1_000_000L
                    )
    ...
    let private pairedGateAttempts (events: ResearchEvent list) =
        let gateEvents eventType =
            ...
            |> List.map (fun event ->
                match
                    payloadString "gateId" event, payloadInt64 "attempt" event, payloadString "targetTreeId" event
                with
                | Some gateId, Some attempt, Some tree when attempt >= 1L && tree <> ResearchContract.Unknown ->
                    Some((gateId, attempt, tree), event)
                | _ -> None)

        let starts, finishes = gateEvents "gate.started", gateEvents "gate.finished"

        if starts |> List.exists Option.isNone || finishes |> List.exists Option.isNone then
            None
        else
            ...
            if
                startMap.Count <> finishMap.Count
                || startMap
                   |> Map.exists (fun key values ->
                       values.Length <> 1
                       || not (finishMap.ContainsKey key)
                       || finishMap[key].Length <> 1)
            then
                None
            else
                Some(
                    startMap
                    |> Map.toList
                    |> List.map (fun (key, values) -> key, values.Head |> snd, finishMap[key].Head |> snd)
                )

    let private allKnownSum selector (events: ResearchEvent list) =
        let selected = events |> List.choose selector

        if List.isEmpty selected || selected.Length <> events.Length then
            None
        else
            Some(List.sum selected)
    ...
    let private intervalDurations stateField (events: ResearchEvent list) =
        ...
        let clocks =
            ordered
            |> List.choose (fun event -> ResearchValue.toOption event.Body.MonotonicClockId)
            |> Set.ofList

        if
            clocks.Count <> 1
            || ordered
               |> List.exists (fun event -> event.Body.MonotonicTimeNs = ResearchValue.Unknown)
        then
            None
        else
            ordered
            ...
            |> List.choose (fun (left, right) ->
                ...
                | ResearchValue.Known startNs, ResearchValue.Known endNs, Some state when endNs >= startNs ->
                    Some(state, (endNs - startNs) / 1_000_000L)
                | _ -> None)
            |> fun spans ->
                if spans.Length = max 0 (ordered.Length - 1) then
                    Some spans
                else
                    None
    ...
    let calculate
        ...
        let missingReason =
            if evidenceClass = ResearchContract.Unknown && not (List.isEmpty events) then
        ...
        let setCount metricId eventType =
            setKnown metricId (typeCount eventType |> invariantInt) rows
        ...
        let sourceCount =
            events |> List.sumBy (fun event -> event.Body.SourceRefs.Length) |> int64

        let resolvable =
            events
            |> List.sumBy (fun event ->
                event.Body.SourceRefs
                |> List.filter (fun source -> source.Resolvable)
                |> List.length)
            |> int64

        setRatio "OBS-SOURCE-RESOLUTION-RATE" resolvable sourceCount rows

        let traceDenominator =
            events
            |> List.filter (fun event -> event.Body.EventType <> "observation.closed")

        let traceResolved =
            traceDenominator
            |> List.filter (fun event -> event.Body.SourceRefs |> List.exists (fun source -> source.Resolvable))
        ...
        |> List.iter (fun (metricId, eventType) ->
            setDistinctKnown metricId eventType (fun event -> ResearchValue.toOption event.Body.RunId))

        [ "TASK-PLANNED", "task.planned"
          "TASK-READY", "task.ready"
          "TASK-IMPLEMENTED", "task.implemented"
          "TASK-REVIEWED", "task.reviewed"
          "TASK-REJECTED", "task.rejected"
          "TASK-ACCEPTED", "task.accepted" ]
        |> List.iter (fun (metricId, eventType) ->
            setDistinctKnown metricId eventType (fun event -> ResearchValue.toOption event.Body.TaskId))

        [ "HUMAN-INSTRUCTION", "human.instruction"
          "HUMAN-REVIEW", "human.review"
          "HUMAN-CORRECTION", "human.correction"
          "HUMAN-APPROVAL", "human.approval"
          "HUMAN-EMERGENCY", "human.emergency"
        ...
        setKnown
            "REPAIR-ATTEMPTED"
            (distinctPayload "repairId" (events |> List.filter (fun e -> e.Body.EventType = "repair.attempted"))
             |> invariantInt)
            rows
        ...
        let fixedRepairs =
            ...
            |> List.filter (fun event ->
                event.Body.EventType = "repair.outcome"
                && payloadString "outcomeClass" event = Some "fixed")
        ...
        setRatio
            ...
            (distinctPayload
                ...
                (events
                 |> List.filter (fun e ->
                     e.Body.EventType = "repair.outcome"
                     && payloadString "outcomeClass" e = Some "fixed")))
            (distinctPayload "repairId" (events |> List.filter (fun e -> e.Body.EventType = "repair.attempted")))
            rows
        ...
        setRatio
            "TASK-REJECTION-RATE"
            (distinctPayload "reviewId" (events |> List.filter (fun e -> e.Body.EventType = "task.rejected")))
            (distinctPayload "reviewId" (events |> List.filter (fun e -> e.Body.EventType = "task.reviewed")))
            rows
        ...
        let humanEvents =
            events
            |> List.filter (fun event -> event.Body.EventType.StartsWith("human.", StringComparison.Ordinal))
        ...
        let countedInterventionIds =
            events
            |> List.filter (fun event ->
                event.Body.EventType.StartsWith("research.intervention.", StringComparison.Ordinal))
        ...
        let accepted =
            events |> List.filter (fun event -> event.Body.EventType = "task.accepted")

        let acceptedTaskIds =
            accepted
            |> List.choose (fun event -> ResearchValue.toOption event.Body.TaskId)
            |> Set.ofList

        let acceptedCount =
            if acceptedTaskIds.Count > 0 && acceptedTaskIds.Count = accepted.Length then
                Some(int64 acceptedTaskIds.Count)
            else
                None

        let milestones =
            events |> List.filter (fun event -> event.Body.EventType = "milestone.reached")

        let reviewEvents =
            events |> List.filter (fun event -> event.Body.EventType = "task.reviewed")
                ...
                | Some [ _, implementation ] ->
                    ...
                    | Some implementationTree ->
                        ...
                        |> Option.bind (fun (_, review) ->
                            ...
                            | Some reviewedTree, Some verdict when reviewedTree = implementationTree ->
                                Some(verdict = "pass")
                            | _ -> None)
                    | None -> None
                | _ -> None)
        ...
        if not (List.isEmpty reviewsByTask) && firstPass.Length = reviewsByTask.Length then
            setRatio
                "REVIEW-FIRST-PASS-RATE"
                (firstPass |> List.filter id |> List.length |> int64)
                (int64 firstPass.Length)
                rows
        ...
        let gateFailures =
            events
            |> List.filter (fun e -> e.Body.EventType = "gate.finished" && e.Body.Result = ResearchValue.Known "fail")
            |> List.length
            |> int64
        ...
        let wipSnapshots =
            events |> List.filter (fun e -> e.Body.EventType = "wip.snapshot.created")

        let changedFiles =
            allKnownSum (fun event -> ResearchValue.toOption event.Body.ChangedFiles) accepted

        let linesAdded =
            allKnownSum (fun event -> ResearchValue.toOption event.Body.LinesAdded) accepted

        let linesDeleted =
            allKnownSum (fun event -> ResearchValue.toOption event.Body.LinesDeleted) accepted

        changedFiles
        |> Option.bind (fun value -> acceptedCount |> Option.bind (invariantRatio value))
        |> Option.iter (fun value -> setKnown "FILES-PER-ACCEPTED" value rows)

        match linesAdded, linesDeleted with
        | Some added, Some deleted ->
            acceptedCount
            |> Option.bind (invariantRatio (added + deleted))
            |> Option.iter (fun value -> setKnown "LINES-PER-ACCEPTED" value rows)
        | _ -> ()
        ...
        let usageEvents =
            ...
            |> List.filter (fun event ->
                ...
                || event.Body.CacheReadTokens <> ResearchValue.Unknown
                || event.Body.CacheWriteTokens <> ResearchValue.Unknown)

        let usage selector = allKnownSum selector usageEvents

        let usageTotals =
            [ usage (fun e -> ResearchValue.toOption e.Body.InputTokens)
              usage (fun e -> ResearchValue.toOption e.Body.OutputTokens)
              usage (fun e -> ResearchValue.toOption e.Body.CacheReadTokens)
              usage (fun e -> ResearchValue.toOption e.Body.CacheWriteTokens) ]

        let usageSemantics =
            usageEvents
            |> List.choose (fun event -> ResearchValue.toOption event.Body.UsageProvenance)
            |> Set.ofList

        let usageProviders =
            usageEvents
            |> List.choose (fun event -> ResearchValue.toOption event.Body.ProviderId)
            |> Set.ofList

        if
            not (List.isEmpty usageEvents)
            && usageTotals |> List.forall Option.isSome
            && usageSemantics.Count = 1
            && usageProviders.Count = 1
            && usageEvents
               |> List.forall (fun event ->
                   event.Body.UsageProvenance <> ResearchValue.Unknown
                   && event.Body.ProviderId <> ResearchValue.Unknown)
        then
            let total = usageTotals |> List.choose id |> List.sum
            setKnown "USE-TOKENS-TOTAL" (invariantInt total) rows

            acceptedCount
            |> Option.bind (invariantRatio total)
            |> Option.iter (fun value -> setKnown "USE-TOKENS-PER-ACCEPTED" value rows)
        ...
        let costs =
            costEvents
            |> List.map (fun event ->
                ResearchValue.toOption event.Body.CostAmount,
                ResearchValue.toOption event.Body.CostCurrency,
                ResearchValue.toOption event.Body.CostProvenance)

        if
            not (List.isEmpty costs)
            && costs
               |> List.forall (fun (amount, currency, provenance) ->
                   amount.IsSome && currency.IsSome && provenance.IsSome)
        then
            let currencies =
                costs |> List.choose (fun (_, currency, _) -> currency) |> Set.ofList

            let provenances =
                costs |> List.choose (fun (_, _, provenance) -> provenance) |> Set.ofList

            let parsed =
                costs
                |> List.choose (fun (amount, _, _) -> amount)
                |> List.map (fun value -> Decimal.TryParse(value, NumberStyles.Number, CultureInfo.InvariantCulture))

            let exact =
                provenances
                |> Set.forall (fun value -> value = "provider-reported" || value = "locally-calculated")
            ...
            if currencies.Count = 1 && exact && parsed |> List.forall fst then
                ...
                | Some count ->
                    ...
                    setKnown
                        "USE-COST-PER-ACCEPTED"
                        (perAccepted.ToString("0.############################", CultureInfo.InvariantCulture))
                        rows
                | None -> ()
                ...
                if fixedRepairs > 0L then
                    ...
                    setKnown
                        "USE-COST-PER-FIX"
                        (perFix.ToString("0.############################", CultureInfo.InvariantCulture))
                        rows
            elif
                currencies.Count = 1
                && provenances = Set.singleton "estimated"
                && parsed |> List.forall fst
            then
                let amount = parsed |> List.sumBy snd
        ...
        if not (Set.isEmpty humanDecisionIds) then
            let humanDurations =
                ...
                |> List.filter (fun event ->
                    countedHuman event
                    && Set.contains
                        (payloadString "decisionActSha256" event |> Option.defaultValue "")
                        humanDecisionIds)
                |> List.groupBy (fun event -> payloadString "decisionActSha256" event)
                |> List.choose (fun (_, values) ->
                    values
                    |> List.tryHead
                    |> Option.bind (fun e -> ResearchValue.toOption e.Body.HumanActiveDurationMs))
        ...
        let activitySpans =
            intervalDurations
                "toActivityState"
                (events |> List.filter (fun e -> e.Body.EventType = "activity.state.changed"))

        let modeSpans =
            intervalDurations
                "toAutonomyMode"
                (events |> List.filter (fun e -> e.Body.EventType = "autonomy.mode.changed"))
        ...
        | Some spans ->
            for state, duration in spans do
                ...
                if rows.ContainsKey id then
                    setKnown id (invariantInt duration) rows
        | None -> ()
        ...
        | Some startUtc, Some endUtc when endUtc > startUtc ->
            ...
            if days > 0.0 then
                ...
                setKnown
                    "ACCEPTED-OUTCOMES-PER-DAY"
                    (acceptedPerDay.ToString("0.############################", CultureInfo.InvariantCulture))
                    rows

                setKnown
                    "MILESTONES-PER-DAY"
                    (milestonesPerDay.ToString("0.############################", CultureInfo.InvariantCulture))
                    rows
        | _ -> ()
        ...
        // envelope can prove.
        let failClosed metricId reason =
            rows[metricId] <- unknown evidenceClass metricId reason
        ...
        | Some attempts when complete || not (List.isEmpty attempts) ->
            ...
            let finishedWith result =
                attempts
                |> List.filter (fun (_, _, finished) -> finished.Body.Result = ResearchValue.Known result)
                |> List.length
                |> int64
        ...
        let interventionFacts =
            ...
            |> List.filter (fun event ->
                ...
                || event.Body.EventType = "research.intervention.recorded")
            |> List.map (fun event ->
                match
                    payloadString "interventionId" event,
                    payloadString "decisionActSha256" event,
                    payloadString "category" event,
                    payloadBool "counted" event
                with
                | Some interventionId, Some decision, Some category, Some counted when
                    decision <> ResearchContract.Unknown
                    ->
                    Some(interventionId, decision, category, counted)
                | _ -> None)

        if
            not (List.isEmpty interventionFacts)
            && not (interventionFacts |> List.exists Option.isNone)
        then
            ...
            if
                decisions
                |> List.forall (fun (_, values) ->
                    values
                    |> List.forall (fun (_, _, category, counted) ->
                        category = (values.Head |> fun (_, _, value, _) -> value)
                        && counted = (values.Head |> fun (_, _, _, value) -> value)))
            then
                let counted =
                    decisions
                    |> List.filter (fun (_, values) -> values.Head |> fun (_, _, _, value) -> value)

                setKnown "INT-COUNT" (counted.Length |> int64 |> invariantInt) rows

                let categories =
                    [ "I1-clarification", "INT-I1-CLARIFICATION"
                      "I2-scope-criteria-change", "INT-I2-SCOPE-CRITERIA-CHANGE"
                      "I3-technical-direction", "INT-I3-TECHNICAL-DIRECTION"
                      "I4-domain-decision", "INT-I4-DOMAIN-DECISION"
                      "I5-priority-change", "INT-I5-PRIORITY-CHANGE"
                      "I6-defect-report", "INT-I6-DEFECT-REPORT"
                      "I7-technical-unblock", "INT-I7-TECHNICAL-UNBLOCK"
                      "I8-infrastructure", "INT-I8-INFRASTRUCTURE"
                      "I9-review-promotion", "INT-I9-REVIEW-PROMOTION"
                      "I10-emergency-stop", "INT-I10-EMERGENCY-STOP"
                      "I11-other", "INT-I11-OTHER" ]

                for category, metricId in categories do
                    setKnown
                        metricId
                        (counted
                         |> List.filter (fun (_, values) -> values.Head |> fun (_, _, value, _) -> value = category)
                         |> List.length
                         |> int64
                         |> invariantInt)
                        rows
                ...
                setKnown
                    ...
                    (counted
                     |> List.filter (fun (_, values) ->
                         values.Head |> fun (_, _, value, _) -> value = ResearchContract.Unknown)
                     |> List.length
                     |> int64
                     |> invariantInt)
                    rows
                ...
                setKnown
                    ...
                    (decisions
                     |> List.filter (fun (_, values) ->
                         values.Head
                         |> fun (_, _, value, counted) -> value = "I0-observation-no-intervention" && not counted)
                     |> List.length
                     |> int64
                     |> invariantInt)
                    rows
            else
                failClosed "INT-COUNT" "invalid-input"
        ...
        let unknownCount =
            ordered
            |> List.filter (fun row -> row.Value = ResearchContract.Unknown)
            |> List.length
            |> int64

        let unknownRate =
            invariantRatio unknownCount (int64 ordered.Length)
    ...
    let calculateWithArchitecture
        ...
        let unknown id reason =
            rows <- update id ResearchContract.Unknown reason

        let integer (text: string) : int64 option =
        ...
        if evidence = ResearchContract.Unknown then
            architectureIds |> List.iter (fun id -> unknown id "mixed-evidence-class")
        elif List.isEmpty checkpoints then
            architectureIds |> List.iter (fun id -> unknown id "source-missing")
        else
            let production =
                checkpoints
                |> List.collect (fun checkpoint ->
                    checkpoint.FileRows |> List.filter (fun row -> row.FileClass = "production"))

            let tests =
                checkpoints
                |> List.collect (fun checkpoint ->
                    checkpoint.FileRows |> List.filter (fun row -> row.FileClass = "test"))
            ...
            let sum (selector: ArchitectureFileRow -> string) (values: ArchitectureFileRow list) : int64 option =
                ...
                if List.isEmpty parsed || parsed |> List.exists Option.isNone then
                    None
                else
                    Some(parsed |> List.choose id |> List.sum)
            ...
            set
                "ARCH-BOUNDARY-VIOLATIONS"
                (checkpoints
                 |> List.collect (fun checkpoint -> checkpoint.ConfirmedFindingIds)
                 |> Set.ofList
                 |> Set.count
                 |> int64
                 |> invariantInt)

            match sum (fun row -> row.Lines) production with
            | Some value -> set "ARCH-PRODUCTION-LINES" (invariantInt value)
            | None -> unknown "ARCH-PRODUCTION-LINES" "source-missing"

            match sum (fun row -> row.Lines) tests with
            | Some value -> set "ARCH-TEST-LINES" (invariantInt value)
            | None -> unknown "ARCH-TEST-LINES" "source-missing"

            match sum (fun row -> row.AnalyzerWarnings) (production @ tests) with
            | Some value -> set "ARCH-ANALYZER-WARNINGS" (invariantInt value)
            | None -> unknown "ARCH-ANALYZER-WARNINGS" "source-missing"
            ...
            let special =
                production
                |> List.filter (fun (row: ArchitectureFileRow) -> Set.contains row.Component integrationComponents)
                |> List.map (fun row -> integer row.LineDelta)

            if (deltas |> List.exists Option.isNone) || (special |> List.exists Option.isNone) then
                unknown "ARCH-INTEGRATION-CONCENTRATION" "source-missing"
            else
                let denominator = deltas |> List.choose id |> List.sumBy abs

                if denominator = 0L then
                    unknown "ARCH-INTEGRATION-CONCENTRATION" "not-applicable"
                else
                    set
                        "ARCH-INTEGRATION-CONCENTRATION"
                        ((decimal (special |> List.choose id |> List.sumBy abs) / decimal denominator)
                            .ToString("0.############################", CultureInfo.InvariantCulture))

        let accepted =
            events
            |> List.choose (fun event ->
                if event.Body.EventType = "task.accepted" then
                    match ResearchValue.toOption event.Body.TaskId, payloadString "acceptedTreeId" event with
                    | Some task, Some tree -> Some(task, tree)
                    | _ -> None
                else
                    None)
            |> Set.ofList
        ...
        if List.isEmpty accepted then
            unknown "ARCH-ACCEPTED-CHECKPOINT-COVERAGE" "not-applicable"
        elif
            accepted
            |> List.exists (fun (task, tree) ->
                checkpoints
                |> List.filter (fun checkpoint ->
                    checkpoint.AcceptedTaskId = task
                    && checkpoint.AcceptedTreeId = tree
                    && not checkpoint.GateCoupled)
                |> List.length
                <> 1)
        then
            unknown "ARCH-ACCEPTED-CHECKPOINT-COVERAGE" "source-missing"
        else
            set "ARCH-ACCEPTED-CHECKPOINT-COVERAGE" "1"
        ...
        | None ->
            architectureIds
            |> List.iter (fun id ->
                if id <> "ARCH-ACCEPTED-CHECKPOINT-COVERAGE" then
                    unknown id "source-unresolvable")
        | Some bound ->
            let production =
                bound
                |> List.collect (fun checkpoint ->
            ...
            let sum selector values =
                ...
                if List.isEmpty values || values |> List.exists Option.isNone then
                    None
                else
                    Some(values |> List.choose id |> List.sum)
            ...
            match sum (fun (row: ArchitectureFileRow) -> row.Lines) production with
            | Some value -> set "ARCH-PRODUCTION-LINES" (invariantInt value)
            | None -> unknown "ARCH-PRODUCTION-LINES" "source-unresolvable"

            match sum (fun (row: ArchitectureFileRow) -> row.Lines) tests with
            | Some value -> set "ARCH-TEST-LINES" (invariantInt value)
            | None -> unknown "ARCH-TEST-LINES" "source-unresolvable"

            match sum (fun (row: ArchitectureFileRow) -> row.AnalyzerWarnings) (production @ tests) with
            | Some value -> set "ARCH-ANALYZER-WARNINGS" (invariantInt value)
            | None -> unknown "ARCH-ANALYZER-WARNINGS" "source-unresolvable"
            ...
            let special =
                ...
                |> List.filter (fun row ->
                    Set.contains
                        row.Component
                        (Set.ofList [ "CommandLoopRunner"; "CommandReportSchema"; "SessionEngine" ]))
                |> List.map (fun row -> integer row.LineDelta)

            if deltas |> List.exists Option.isNone || special |> List.exists Option.isNone then
                unknown "ARCH-INTEGRATION-CONCENTRATION" "source-unresolvable"
            else
                let denominator = deltas |> List.choose id |> List.sumBy abs
        ...
        let dynamicArchitectureRows =
            ...
            let total =
                if totalLines |> List.exists Option.isNone then
                    None
                else
                    Some(totalLines |> List.choose id |> List.sum)
            ...
            |> List.collect (fun componentId ->
                let lines =
                    ...
                    |> List.map (fun row -> integer row.Lines)

                let share =
                    if lines |> List.exists Option.isNone then
                        ResearchContract.Unknown, "source-missing"
                    else
                        match total with
                        | Some denominator when denominator > 0L ->
                            (Decimal.Round(
                                decimal (lines |> List.choose id |> List.sum) / decimal denominator,
                                6,
                                MidpointRounding.AwayFromZero
                            ))
                                .ToString("0.000000", CultureInfo.InvariantCulture),
                            "observed"
                        | _ -> ResearchContract.Unknown, "not-applicable"

                [ { MetricId = "ARCH-COMPONENT-SHARE:" + componentId
                    Value = fst share
                    Unit = "ratio"
                    AvailabilityReason = snd share
                    EvidenceClass = evidence }
                  { MetricId = "ARCH-COMPLEXITY:" + componentId
                    Value = ResearchContract.Unknown
                    Unit = "method"
                    AvailabilityReason = "source-missing"
                    EvidenceClass = evidence } ])
